...
31|0]>>a%31&1:null};this.getRange=function(a,b){if(a<=b&&0<=a&&b<31*d){for(var c=new BitSet(b-a+1),e=a;e<=b;e++)c.set(e-a,this.get(e));return c}return null};this.clear=function(a,b){return k(this,a,b,0)};this.flip=function(a,b){return k(this,a,b,1)}}module&&module.exports&&(module.exports.BitSet=BitSet);
